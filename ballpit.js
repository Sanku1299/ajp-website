...
const b = new Map(), A = new THREE.Vector2();
let R = false;
...
class Y extends THREE.MeshPhysicalMaterial {
  constructor(e) {
    ...
    this.onBeforeCompile = e => {
      ...
      const t = THREE.ShaderChunk.lights_fragment_begin.replaceAll(
...
class Z extends THREE.InstancedMesh {
  constructor(e, t = {}) {
    ...
    const o = new THREE.SphereGeometry();
...
export function createBallpit(e, t = {}) {
  const i = new x({
    canvas: e,
    size: 'parent',
...
// Initialize Ballpit automatically when the script runs
window.addEventListener('DOMContentLoaded', () => {
  ...
  if (canvas) {
    createBallpit(canvas, { 
        ...
        gravity: 0.6, 
        friction: 0.98,
        colors: [0x0055ff, 0x00e5ff, 0x0033cc], 
        followCursor: true,
        minSize: 0.3,
        maxSize: 0.8,
